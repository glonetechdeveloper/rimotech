...
let   canvasEmpty    = document.getElementById('canvasEmpty');
...
document.querySelectorAll('.choice-icon').forEach(el => {
...
function renderModule(type){
  ...
  el.className = 'module';
  el.innerHTML = moduleTemplates[type]();
  moduleField.appendChild(el);
}
